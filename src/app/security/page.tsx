      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-6">
        ...
        <section className="mt-8 grid gap-5 lg:grid-cols-[1.5fr_1fr]">
          ...
          <aside className="rounded-2xl border border-amber-500/25 bg-amber-500/5 p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-[var(--text-secondary)]">If you discover a security vulnerability, please report it privately to the maintainer via GitHub. Do not include tokens, private files, or exploit details in a public issue.</p>
          </aside>
        </section>
      </div>
    </div>
